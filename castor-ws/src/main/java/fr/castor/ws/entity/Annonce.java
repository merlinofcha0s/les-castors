...
@NamedQueries(value = {
        ...
        @NamedQuery(name = QueryJPQL.ANNONCE_BY_DEMANDEUR_LOGIN_FETCH_ARTISAN,
                query = "SELECT a.description, a.etatAnnonce, count(art), a.hashID FROM Annonce AS a LEFT OUTER JOIN a.artisans AS art WHERE a.demandeur.login = :login AND a.etatAnnonce != 4 AND a.etatAnnonce != 1 GROUP BY a ORDER BY dateCreation DESC"),
        @NamedQuery(name = QueryJPQL.ANNONCE_BY_ARTISAN_LOGIN_FETCH_ARTISAN,
                query = "SELECT a.description, a.etatAnnonce, count(art), a.hashID FROM Annonce AS a LEFT OUTER JOIN a.artisans AS art WHERE art.login = :login AND a.etatAnnonce != 4 AND a.etatAnnonce != 1 GROUP BY a ORDER BY dateCreation DESC"),
        ...
        @NamedQuery(name = QueryJPQL.NB_ANNONCE_BY_LOGIN_FOR_CLIENT,
                query = "SELECT count(a) FROM Annonce AS a WHERE a.demandeur.login = :login AND a.etatAnnonce != 4 AND a.etatAnnonce != 1"),
        @NamedQuery(name = QueryJPQL.NB_ANNONCE_BY_LOGIN_FOR_ARTISAN,
                query = "SELECT count(a) FROM Annonce AS a LEFT OUTER JOIN a.artisans AS art WHERE art.login = :login AND a.etatAnnonce != 4 AND a.etatAnnonce != 1"),
