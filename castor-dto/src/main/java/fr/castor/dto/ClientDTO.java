...
public class ClientDTO extends AbstractDTO {
    ...
    @Size(min = ValidatorConstant.CLIENT_NOM_MIN, max = ValidatorConstant.CLIENT_NOM_MAX)
    private String nom;
    @Size(min = ValidatorConstant.CLIENT_PRENOM_MIN, max = ValidatorConstant.CLIENT_PRENOM_MAX)
    private String prenom;
    @Pattern(message = "Numero de téléphone invalide", regexp = ValidatorConstant.TELEPHONE_REGEX)
