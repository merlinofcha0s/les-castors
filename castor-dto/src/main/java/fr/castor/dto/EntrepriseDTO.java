...
public class EntrepriseDTO extends AbstractDTO {
    ...
    @NotNull
    @Pattern(message = "Format siret invalide", regexp = ValidatorConstant.ENTREPRISE_SIRET_REGEXP)
    ...
    @Size(min = ValidatorConstant.ENTREPRISE_SPECIALITE_MIN, max = ValidatorConstant.ENTREPRISE_SPECIALITE_MAX)
